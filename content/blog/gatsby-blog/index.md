...
author: franleplant
description: "In this post we are going to cover the steps we took to create the nosleepjavascript.com blog 
...
Since this blog qualifies as a *project site* (per repo) instead of a *user or organization site*
